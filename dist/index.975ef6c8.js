...
},{"core-js/modules/web.immediate.js":"49tUX","../sass/main.scss":"5Izhf","regenerator-runtime/runtime":"dXNgZ","./modules/controller":"l3lnG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
},{"../internals/export":"dIGt4","../internals/global":"i8HOC","../internals/task":"7jDg7"}],"5Izhf":[function() {},{}],"dXNgZ":[function(require,module,exports) {
/**
...
},{}],"l3lnG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
async function appController() {
    try {
        // Check if Mobile
        if (!(0, _viewDefault.default).mobile) {
            // call the Wufoo Data
            await Promise.race([
                (0, _modelDefault.default).theData(),
                (0, _utilities.timeout)()
            ]);
            // Show the Data
        ...
        } else (0, _viewDefault.default).mobileRedirect();
    } catch (err) {
        (0, _viewDefault.default).showError(err);
        console.error(err);
    }
}
exports.default = appController;

},{"./model":"8PI2T","./utilities":"5HnRK","./View":"byZDR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8PI2T":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utilities = require("./utilities");
class Model {
...
class View {
    ...
    wufooFormURL = "https://firstchurchcarrollton.wufoo.com/forms/rt2tdqd0lcp3yx/";
    constructor(){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire2b73")
